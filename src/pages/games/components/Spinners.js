...
export default function Spinners(){
    ...
    <div className="spinner-cont">
      ...
      <Spinner animation="border" variant="warning" /><Spinner animation="grow" variant="warning" />
      <Spinner animation="border" variant="info" /><Spinner animation="grow" variant="info" />
      <Spinner animation="border" variant="light" /><Spinner animation="grow" variant="light" />
      <Spinner animation="border" variant="dark" /><Spinner animation="grow" variant="dark" />
    </div>
    )
}
