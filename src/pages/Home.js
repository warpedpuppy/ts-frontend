  ...
  render() {
    return (
      ...
      <section id="main-text">
        ...
        <p>I talk about my professional history on the about page.  Mostly this site is devoted to whatever <Link to="/js">js</Link>, <Link to="/css">css</Link>, or <Link to="/dbs">db</Link> issue I&apos;m currently dealing with or trying to communicate to a student.</p>
